...
<div id="page-content" class="profile2">
    <div class="bg-primary clearfix">
        <div class="col-md-4">
            <div class="row">
                ...
                <div class="col-md-9">
                    <h4 class="name">{{ $resource_type->$view_col }}</h4>
                    <div class="row stats">
        ...
        <div class="col-md-1 actions">
            @la_access("Resource_types", "edit")
                <a href="{{ url(config('laraadmin.adminRoute') . '/resource_types/'.$resource_type->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
            @endla_access
            
            @la_access("Resource_types", "delete")
                {{ Form::open(['route' => [config('laraadmin.adminRoute') . '.resource_types.destroy', $resource_type->id], 'method' => 'delete', 'style'=>'display:inline']) }}
    ...
    <ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
        <li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/resource_types') }}" data-toggle="tooltip" data-placement="right" title="Back to Resource types"><i class="fa fa-chevron-left"></i></a></li>
