...
<div id="page-content" class="profile2">
    <div class="bg-primary clearfix">
        <div class="col-md-4">
            <div class="row">
                ...
                <div class="col-md-9">
                    <h4 class="name">{{ $room_type->$view_col }}</h4>
                    <div class="row stats">
        ...
        <div class="col-md-1 actions">
            @la_access("Room_Types", "edit")
                <a href="{{ url(config('laraadmin.adminRoute') . '/room_types/'.$room_type->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
            @endla_access
            
            @la_access("Room_Types", "delete")
                {{ Form::open(['route' => [config('laraadmin.adminRoute') . '.room_types.destroy', $room_type->id], 'method' => 'delete', 'style'=>'display:inline']) }}
    ...
    <ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
        <li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/room_types') }}" data-toggle="tooltip" data-placement="right" title="Back to Room Types"><i class="fa fa-chevron-left"></i></a></li>
