...
<div id="page-content" class="profile2">
    <div class="bg-primary clearfix">
        <div class="col-md-4">
            <div class="row">
                ...
                <div class="col-md-9">
                    <h4 class="name">{{ $car_request_status->$view_col }}</h4>
                    <div class="row stats">
        ...
        <div class="col-md-1 actions">
            @la_access("Car_Request_Statuses", "edit")
                <a href="{{ url(config('laraadmin.adminRoute') . '/car_request_statuses/'.$car_request_status->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
            @endla_access
            
            @la_access("Car_Request_Statuses", "delete")
                {{ Form::open(['route' => [config('laraadmin.adminRoute') . '.car_request_statuses.destroy', $car_request_status->id], 'method' => 'delete', 'style'=>'display:inline']) }}
    ...
    <ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
        <li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/car_request_statuses') }}" data-toggle="tooltip" data-placement="right" title="Back to Car Request Statuses"><i class="fa fa-chevron-left"></i></a></li>
            ...
            <div class="tab-content">
                <div class="panel infolist">
                    ...
                    <div class="panel-body">
                        @la_display($module, 'requestedperson_id')
						@la_display($module, 'status')
						@la_display($module, 'date')
						@la_display($module, 'remark')
						@la_display($module, 'car_requested_id')
                    </div>
                </div>
            </div>
        </div>
